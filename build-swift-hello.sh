...
swift build -c release --build-path ${SWIFT_HELLO_BUILDDIR} --destination ${SWIFTPM_DESTINATION_FILE}

echo "Copy swift-hello"
sudo cp $SWIFT_HELLO_BUILDDIR/release/swift-hello ${STAGING_DIR}/usr/local/bin