...
SWIFT_RUNTIME_AND_STDLIB_EXTRA_FLAGS=${SWIFTC_EXTRA_FLAGS// /;}
...
cmake -S $SWIFT_SRCDIR -B $SWIFT_BUILDDIR -G Ninja \
        ...
        -DCMAKE_OSX_SYSROOT="" \
        -DSWIFT_RUNTIME_SWIFT_COMPILE_FLAGS="${SWIFT_RUNTIME_AND_STDLIB_EXTRA_FLAGS}" \
        -DSWIFT_STDLIB_EXTRA_SWIFT_COMPILE_FLAGS="${SWIFT_RUNTIME_AND_STDLIB_EXTRA_FLAGS}"
